...
<html lang="en">
    ...
    <section class="main">
      ...
      <div class="hero">
        <div id="hero" class="text-center">
          <h1>musicous</h1>
          <p>
            An advanced musicous, supports Spotify, Soundcloud, YouTube
          ...
          <div class="row justify-content-center text-center">
            <div class="col-md-10 col-lg-8">
              <div class="header-section">
                ...
                <p class="description">
                  There are many Features in musicous! Every awesome
        ...
        <div class="container">
          <div class="row">
           ...
           <div class="copyright-text">
                    <p>
                      © 2021
                      <a href="https://github.com/venom-hun5/music-bot.git"
                        >musicous</a
                      >. All rights reserved. Made by
                      <a href="https://www.instagram.com/joker_hun5">Mr Venom</a> 
  ...
  <script>
    $(document).ready(() => {
      $.get("/api/info", (data) => {
        //check api/routes.js
        let url = `https://discord.com/api/oauth2/authorize?client_id=848919449532629044&permissions=8&scope=bot`;
        
        $("#hero").append(`<a href="${url}" class="btn btn-primary" type="button">Invite</a>
            <a href="#" class="btn btn-outline-primary" type="button">Dashboard Coming Soon</a>`);
      });
